...
public class LocalState {
	...
	HashMap<String, State> transitions = new HashMap<String, State>(); // port
																		// name
																		// ->
																		// state
	...
	public LocalState(State s, Component c) {
		state = s;
		component = c;
		AtomType atomType = (AtomType) component.getType();
		id = ((PetriNet) atomType.getBehavior()).getState().indexOf(state);
